            ...
            <table width="600" cellpadding="0" cellspacing="0" style="background:#ffffff; border-radius:8px; overflow:hidden;">
                ...
                <tr>
                    <td style="padding:30px; color:#333;">
                        <h2 style="margin-top:0;">Admission Confirmation</h2>

                        <p>Congraturations <strong><?= htmlspecialchars($firstname) ?></strong>,</p>

                        <p>
                            We are delighted to inform you that you have been admitted.  
                        </p>
